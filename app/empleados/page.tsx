      ...
      <main className="flex-1 p-6 overflow-auto flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground">Administra empleados y pagos diarios</p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold">{todayPayments.length}</span>
                <span className="text-muted-foreground">de {employees.length}</span>
              </div>
            </CardContent>
          </Card>
          <Card>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-muted-foreground">Pago base</p>
                          <p className="font-semibold">${employee.dailyPayBase.toFixed(2)}</p>
                        </div>
                        {payment ? (
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setEmployeeForm(prev => ({ ...prev, position: value }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
        ...
        <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
          <DialogContent>
                ...
                <div className="rounded-lg bg-secondary/50 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{payingEmployee.position}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    {paymentForm.amount !== payingEmployee.dailyPayBase && (
                      <span className={paymentForm.amount > payingEmployee.dailyPayBase ? "text-success" : "text-destructive"}>
                        {paymentForm.amount > payingEmployee.dailyPayBase ? "+" : ""}
                        ${(paymentForm.amount - payingEmployee.dailyPayBase).toFixed(2)}
                      </span>
                    )}
                  </div>
                </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSavePayment} className="bg-success text-success-foreground hover:bg-success/90">
                Registrar Pago
              </Button>
            </DialogFooter>
          </DialogContent>
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ¿Estas seguro de eliminar este empleado? Esta accion no se puede deshacer.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
